/**
 * render-html.js — HTML rendering functions for browser Shadow DOM
 */
...
// TODO: move nav bar and sticky pill to editor shell when SPA lands
...
function renderHtml(store) {
  ...
  // TODO: move sticky pill to editor shell when SPA lands
