...
└── docs/
    ...
    └── program_management/          # Launch tracking
        ├── aide_launch_plan.md
        └── build_log/
            ├── PHASE_0_1_INFRASTRUCTURE.md
            └── PHASE_0_2_AUTH.md
```
...
| `docs/program_management/aide_launch_plan.md` | 5-phase launch plan with Signal ear, task checklists |
